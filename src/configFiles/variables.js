...
{
    BACKEND_URL:  "https://braedens-backend.azurewebsites.net/api/" ,
    BACKEND_MAP_URL: "https://braedens-api.azurewebsites.net/api/map/" ,
...
} :
{
    ...
    BACKEND_MAP_URL: import.meta.env.VITE_BACKEND_MAP_URL ,
